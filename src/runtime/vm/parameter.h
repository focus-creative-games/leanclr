...
class Parameter
{
  public:
    ...
    static RtResult<RtObject*> get_parameter_default_value_object(metadata::RtModuleDef* mod, metadata::EncodedTokenId param_token, const metadata::RtTypeSig* type);
};
} // namespace vm
} // namespace leanclr