...
{
    internal class TC_Ble : GeneralTestCaseBase
    {
        [UnitTest]
        ...
        [UnitTest]
        public static unsafe void s_ref_3()
        {
            int* a = (int*)3;
            int* b = (int*)2;
            if (a <= b)
        ...
        [UnitTest]
        public static unsafe void ref_3()
        {
            int* x = (int*)3;
            int* y = (int*)2;
            if (x <= y)
