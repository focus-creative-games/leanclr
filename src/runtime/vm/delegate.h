...
class Delegate
{
  public:
    ...
    static RtResult<RtMulticastDelegate*> create_delegate_from_reflection(RtReflectionType* delegate_type, RtObject* target, const metadata::RtMethodInfo* method, bool throw_on_bind) noexcept;
